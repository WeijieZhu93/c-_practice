//
// Created by Fantasy’s Mac on 2018/4/7.
//
...
namespace stl {
    ...
    public:
        ...
        void reserve(int newCapacity) {
            ...
            /*把原有的内容拷贝到临时数组中*/
            Object *temp = new Object[theSize];
            for (int i=0;i<theSize;i++) temp[i] = Objects[i];
            /*为对象重新分配更大的内存空间*/
        ...
        typedef Object *iterator;               //定义迭代器
        typedef const Object *const_iterator;   //定义常量迭代器
